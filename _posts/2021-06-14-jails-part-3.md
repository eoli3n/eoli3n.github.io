...
Clean all roles in the Ansible project from previous parts.
By the way, this post how Ansible is kind of auto documented, as each tasks has a name, the Ansible code is pretty clean to read, even if you don't know the tool.
...
Add the task to copy the website to the jail.
```yaml
...
TASK [jails : bootstrap 13.0 release] ******************************************************************************
changed: [host-test]
...
TASK [nginx : Create nginx config path] ****************************************************************************
changed: [host-test]
...
TASK [nginx : create nginx jail] ***********************************************************************************
changed: [host-test]

TASK [nginx : start nginx jail] ************************************************************************************
changed: [host-test]

TASK [nginx : template nginx jail with nginx template] *************************************************************
changed: [host-test]
